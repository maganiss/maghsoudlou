...
class FriendshipsControllerTest < ActionController::TestCase
  ...
  test "should create friendship" do
    assert_difference('Friendship.count') do
      post :create, friendship: { friend_id: @friendship.friend_id, friendship_status: @friendship.friendship_status, user_id: @friendship.user_id }
    end
  ...
  test "should update friendship" do
    patch :update, id: @friendship, friendship: { friend_id: @friendship.friend_id, friendship_status: @friendship.friendship_status, user_id: @friendship.user_id }
    assert_redirected_to friendship_path(assigns(:friendship))
  end
